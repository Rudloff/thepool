...
public class UpDownMovingTrap extends GObject implements Cloneable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1637630157353427447L;

	public UpDownMovingTrap(int id, TileMap tilemap) {
		super(id, true);
