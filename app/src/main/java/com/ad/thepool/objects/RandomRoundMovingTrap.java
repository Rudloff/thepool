...
public class RandomRoundMovingTrap extends GObject implements Cloneable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5763134146616037062L;

	public RandomRoundMovingTrap(int id, TileMap tilemap) {
		super(id, true);
