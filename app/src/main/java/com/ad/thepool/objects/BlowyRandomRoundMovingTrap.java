...
public class BlowyRandomRoundMovingTrap extends GObject implements Cloneable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2995245151010564647L;

	public BlowyRandomRoundMovingTrap(int id, TileMap tilemap) {
		super(id, true);
		TransformTileComponent tiletransform = new TransformTileComponent('V', true, Z_MAIN);
		...
		MoveComponent move = new MoveComponent(true, 4, MoveComponent.TYPE_RANDOM_ROUND_MOVE);
