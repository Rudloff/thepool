...
public class FontaineCanonRight extends GObject implements Cloneable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3355139056075164721L;

	public FontaineCanonRight(int id, TileMap tilemap) {
		super(id, true);
		...
		FontaineComponent fontaine = new FontaineComponent(true, FontaineComponent.FONTAINE_RIGHT, "std", "fontaine", 1);
