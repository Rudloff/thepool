...
public class BlowyUpDownMovingTrap extends GObject implements Cloneable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1413337747513239447L;

	public BlowyUpDownMovingTrap(int id, TileMap tilemap) {
		super(id, true);
		TransformTileComponent tiletransform = new TransformTileComponent('L', true, Z_MAIN);
		...
		MoveComponent move = new MoveComponent(true, 4, MoveComponent.TYPE_UPDOWN_MOVE);
