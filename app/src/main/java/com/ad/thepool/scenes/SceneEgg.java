...
public class SceneEgg extends Scene {
	/**
	 * 
	 */
	...
	public SceneEgg(int order, Game game) {
		super(order, game);
	}
	...
	public void init() {
		...
		clearScene();
		Map map = new Map("maps/egg.lvl", null);
		addMap(map);
		addMouseCursor();
		addMenu();
		...
		help = addTextBox(1, 1, 23, 5, "Can be quick...", GraphicsWrapper.COLOR_WHITE, true, RenderTextComponent.POS_LEFT_UP, false, null, null);
		saveCheckPoint(true);
	}
