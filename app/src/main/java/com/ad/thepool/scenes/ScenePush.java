...
public class ScenePush extends Scene {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3178707480752634211L;
	Exit exit;

	public ScenePush(int order, Game game) {
		super(order, game);
	}
	...
	public void init() {
		...
		Map map = new Map("maps/push.lvl", null);
		addMap(map);
		addMouseCursor();
		addMenu();
