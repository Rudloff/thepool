...
public class SceneBreak extends Scene {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1687869582973678658L;
	Exit exit;

	public SceneBreak(int order, Game game) {
		super(order, game);
	}
	...
	public void init() {
		...
		clearScene();
		Map map = new Map("maps/break.lvl", null);
		addMap(map);
		addMouseCursor();
		addMenu();
