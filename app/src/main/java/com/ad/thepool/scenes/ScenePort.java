...
public class ScenePort extends Scene {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6462523784941978208L;
	Exit exit;

	public ScenePort(int order, Game game) {
		super(order, game);
	}
	...
	public void init() {
		...
		clearScene();
		Map map = new Map("maps/port.lvl", null);
		addMap(map);
		addMouseCursor();
		addMenu();
